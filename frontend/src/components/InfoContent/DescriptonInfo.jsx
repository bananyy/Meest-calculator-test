  ...
  return (
    <div className="w-full flex justify-between relative my-8">
      <div className="max-w-[530px] text-center mt-[180px] sm:mt-[200px]">
        <h2 className="text-sm-h md:text-md-h lg:text-lg-h w-10/12 md:w-full text-mainblue">
          Про Наш Продукт
        </h2>
        <p className="py-5 text-sm-p md:text-md-p lg:text-lg-p">
      ...
      <div className="max-w-[300px] sm:max-w-none sm:w-[350px] md:w-[450px] absolute right-0">
