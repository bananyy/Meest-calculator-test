    ...
    <>
      <div className="flex flex-col items-center py-2 w-full">
        <div className="w-full bg-[#EFF1F4] rounded-[40px] py-8 relative px-3 sm:px-6 md:px-8 lg:px-16 xl:px-24 calc-shadow-box my-8">
          ...
          <div className="text-sm-p sm:text-md-p lg:text-lg-p flex absolute items-center gap-2 justify-around mt-4 left-5 right-5 flex-col md:items-end md:right-10">
          ...
          <div className="flex items-end mt-[180px] max-md:hidden">{personTypeElements()}</div>

          <div className="mt-[180px] md:hidden">
            <Slider
